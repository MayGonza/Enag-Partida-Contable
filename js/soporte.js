...
(function () {
    ...
    async function enviarTicketSoporte(e) {
        ...
        // Crear plantilla HTML visual idéntica con estilos institucionales ENAG (#002147)
        const htmlTemplate = `
                ...
                <td style="padding: 25px;">
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; border-collapse: collapse; margin-bottom: 20px; background-color: #f8fafc; border-radius: 10px; overflow: hidden; border: 1px solid #e2e8f0;">
                    <tr>
                      ...
                      <td style="padding: 12px 16px; font-size: 14px; color: #334155; border-bottom: 1px solid #e2e8f0;"><strong>${datos.nombre}</strong></td>
                    </tr>
                    <tr>
                      ...
                      <td style="padding: 12px 16px; font-size: 14px; color: #334155; border-bottom: 1px solid #e2e8f0;">${datos.fechaHora}</td>
                    </tr>
                    <tr>
                      ...
                      <td style="padding: 12px 16px; font-size: 14px; color: #334155; border-bottom: 1px solid #e2e8f0;"><strong>${datos.departamento}</strong></td>
                    </tr>
                    <tr>
        ...
        // Intentar envío web mediante Web3Forms con plantilla HTML completa
